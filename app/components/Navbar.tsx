...
export default function Navbar(props: NavbarProps) {
    const [menuSize, setMenuSize] = useState<string>("calc(100vh - 20px)");
            ...
            { props.isLargeScreen ?
                ...
                <div className="
                    ...
                    " style={{height: menuSize}}>
                        ...
                        <div className="flex flex-col items-center h-[calc(100vh-70px)] justify-center flex-shrink-0">
                            <Link href="/" onMouseUp={() => setMenuSize("50px")}
                            className="text-[13px] w-[100px] cursor-pointer text-center hover:opacity-80 mb-[50px]">
                                Home
                            </Link>
                            <Link href="#download-section" onMouseUp={() => setMenuSize("50px")}
                            className="text-[13px] w-[100px] cursor-pointer text-center outlined-text hover:opacity-80 mb-[50px]">
                                Download
                            </Link>
                            <Link href="#faq-section" onMouseUp={() => setMenuSize("50px")}
                            className="text-[13px] w-[100px] cursor-pointer text-center hover:opacity-80 mb-[50px]">
                                FAQ
                            </Link>
                        </div>
